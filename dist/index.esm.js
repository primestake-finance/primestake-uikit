...
var Logo = function (_a) {
    ...
    return (React.createElement(IconContainer, null, isPushed
        ? React.createElement("img", __assign({}, props, { src: "/images/logo-expanded.png", alt: "Logo Expanded", width: "640", height: "145" }))
        : React.createElement("img", __assign({}, props, { src: "/images/logo-condensed.png", alt: "Logo Condensed", width: "512", height: "512" }))));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, null,
        ...
        React.createElement(Link, { href: "https://ftmscan.com/token/0xa7dee6923f9511a38039b41dec2abeeba4ffff4f", style: { marginLeft: "5px", textDecoration: "none" }, target: "_blank", color: "textSubtle", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
